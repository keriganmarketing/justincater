...
class iHomefinderAdminPageConfig extends iHomefinderAdminAbstractPage {
			...
			<div class="postbox closed">
				...
				<div class="inside">
					<table class="form-table condensed">
						...
						<?php } ?>
						<?php if($metaTagsOption !== null && iHomefinderDisplayRules::getInstance()->supportsSeoVariables()) { ?>
							<tr>
								<th>
	...
	private function getAutoComplete($virtualPage, $fieldId) {
		...
		if(!empty($variables) && iHomefinderDisplayRules::getInstance()->supportsSeoVariables()) {
