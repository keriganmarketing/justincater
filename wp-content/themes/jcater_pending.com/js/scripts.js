...
//Featured Properties SLICK
	...
	function appendElementsmobile(){
		if(jQuery(window).width() <= 977){
			jQuery('#hp-properties').insertAfter('#slideshow');
			jQuery('#hp-cta-holder').insertAfter('#hp-welcome-holder');
		}else if(jQuery(window).width() > 977){
			jQuery('#hp-cta-holder').insertAfter('#slideshow');
			jQuery('#hp-properties').insertAfter('#hp-welcome-holder');
		}
		
	}
	
	jQuery(document).ready(function(){
		appendElementsmobile();
